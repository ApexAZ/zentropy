...
class TestOAuthOrganizationCreation:
    ...
    def test_google_workspace_creates_organization(self, mock_verify_google_token, db, client):
    ...
    @patch('api.routers.auth.verify_google_token')
    def test_existing_organization_reused(self, mock_verify_google_token, db, client):
    ...
    @patch('api.routers.auth.verify_google_token')
    def test_gmail_user_auto_organization(self, mock_verify_google_token, db, client):
...
class TestOrganizationDeduplication:
    ...
    @patch('api.routers.auth.verify_google_token')
    def test_case_insensitive_domain_matching(self, mock_verify_google_token, db, client):
