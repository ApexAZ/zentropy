...
class TestRememberMeBackend:
    ...
    def test_user_login_schema_accepts_remember_me_field(self):
    ...
    def test_user_login_schema_defaults_remember_me_false(self):
    ...
    def test_login_with_remember_me_true_creates_extended_token(self):
    ...
    def test_login_with_remember_me_false_creates_normal_token(self):
    ...
    def test_login_without_remember_me_defaults_to_normal_token(self):
...
class TestRememberMeConstants:
    ...
    def test_extended_token_expiration_constant_exists(self):
    ...
    def test_create_access_token_accepts_remember_me_parameter(self):
