...
from ..schemas import TeamResponse, TeamCreate, TeamUpdate, TeamWithMembers, MessageResponse
...
def get_team(
    ...
    # Get team members
    members = db.query(database.User).join(database.TeamMembership).filter(
