	...
	return (
		<main className="w-full py-8">
			<div className="mb-8 flex items-center justify-between">
				<h2 className="text-primary m-0 text-3xl font-semibold">About Zentropy</h2>
			</div>
			...
			<section className="bg-content-background rounded-lg p-8 shadow-sm">
				...
				<h3 className="text-primary mb-3 text-xl font-semibold">Our Vision</h3>
				<p className="text-primary mb-4">
				...
				<h3 className="text-primary mb-3 text-xl font-semibold">Key Features</h3>
