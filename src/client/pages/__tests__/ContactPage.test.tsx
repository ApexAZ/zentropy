...
describe("ContactPage", () => {
	...
	it("should display the introduction paragraph", () => {
		...
		expect(introText).toHaveClass("text-text-primary", "font-body", "mb-4");
	});
	...
	it("should display the 'Get In Touch' section with proper content", () => {
		...
		expect(getInTouchHeading).toHaveClass("text-text-contrast", "font-heading-medium", "mb-3");
		...
		expect(getInTouchText).toHaveClass("text-text-primary", "font-body", "mb-4");
	});
	...
	it("should display the Support section with proper content", () => {
		...
		expect(supportHeading).toHaveClass("text-text-contrast", "font-heading-small", "mb-2");
		...
		expect(supportDescription).toHaveClass("text-text-primary", "font-body", "mb-2");
	...
	it("should display the General Inquiries section with proper content", () => {
		...
		expect(generalInquiriesHeading).toHaveClass("text-text-contrast", "font-heading-small", "mb-2");
		...
		expect(generalInquiriesDescription).toHaveClass("text-text-primary", "font-body", "mb-2");
	...
	it("should display the Feedback section with proper content", () => {
		...
		expect(feedbackHeading).toHaveClass("text-text-contrast", "font-heading-small", "mb-2");
		...
		expect(feedbackDescription).toHaveClass("text-text-primary", "font-body", "mb-2");
	...
	it("should display the Office Hours section with proper content", () => {
		...
		expect(officeHoursHeading).toHaveClass("text-text-contrast", "font-heading-medium", "mb-3");
		...
		expect(officeHoursIntro).toHaveClass("text-text-primary", "font-body", "mb-4");
	});
	...
	it("should display all office hours with proper formatting", () => {
		...
		expect(officeHoursList).toHaveClass("text-text-primary", "font-body", "mb-4", "list-none");
	...
	it("should use semantic styling classes consistently", () => {
		...
		expect(h2Heading).toHaveClass("text-text-contrast");

		const h3Headings = screen.getAllByRole("heading", { level: 3 });
		expect(h3Headings).toHaveLength(2);
		h3Headings.forEach(heading => {
			expect(heading).toHaveClass("text-text-contrast");
		});
