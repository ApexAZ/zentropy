...
describe('RegisterPage', () => {
  ...
  it('successfully registers user with valid data', async () => {
    ...
    expect(screen.getByText('Welcome to Zentropy! Your account has been created and you\'re now logged in.')).toBeInTheDocument();
  ...
  it('shows rate limiting information', () => {
    ...
    expect(screen.getByText('For security, only 2 account registrations are allowed per hour from each location.')).toBeInTheDocument();
  });
