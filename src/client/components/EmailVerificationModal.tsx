	...
	if (success) {
		return (
			<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
				<div className="bg-content-background w-full max-w-md rounded-lg shadow-xl">
			...
			<div className="bg-content-background max-h-[90vh] w-full max-w-md overflow-y-auto rounded-lg shadow-xl">
				<div className="p-6">
					...
					>
							...
							<div className="flex justify-between gap-2">
								{inputRefs.map((ref, index) => (
									<input
										...
										className="border-layout-background focus:border-interactive focus:ring-interactive h-12 w-12 rounded-lg border text-center text-lg font-semibold focus:ring-1 focus:outline-none"
									/>
								))}
							</div>
						</div>
						...
						<button
							type="submit"
							disabled={isVerifying || code.length !== 6 || !email.trim()}
							className="bg-interactive hover:bg-interactive-hover w-full rounded-lg px-4 py-2 font-medium text-white disabled:cursor-not-allowed disabled:opacity-50"
						>
